...
{\Large \begin{center}$title$\end{center}}
$if(subtitle)$\begin{center}$subtitle$\end{center}$endif$

$if(keywords)$
\vskip 8em \begin{center}\emph{Keywords}: $keywords$\end{center} \par
$else$
$endif$

% International Relations with specialization in GPE
% Spring Term 2023
% Student: Erika Eriksson
% Supervisor: Johan Johansson
