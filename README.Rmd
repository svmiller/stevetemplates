...
The easiest way to use my templates is within Rstudio. Go to *File > New File > R Markdown*. Here, select any template you'd like to use. The development version should have more options, but the options published right now on CRAN include:
