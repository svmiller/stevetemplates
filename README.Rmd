...
- **Steve's Statement Template**: I created this template in 2016 (I believe). I use it for writing various "statements" (e.g. research statement, teaching statement) when applying for jobs. I also use it for miscellaneous university busy work. You can call it in the YAML with `stevetemplates::statement`.
